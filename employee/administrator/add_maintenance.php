     ...
     <!-- This is the php file for add a new employee in maintenance -->
<?php
...
<li><a href='/final-melwinkle/employee/administrator/administrator_dashboard.php'><i class='icon ion-md-home' size='large'></i> Dashboard</a></li>
<li><a href="/final-melwinkle/employee/administrator/administrator_employee.php">  <i class='icon ion-md-people' size='large'></i> Employees</a></li>
...
<li><a href='/final-melwinkle/employee/bin.php'><i class='icon ion-md-trash' size='large'></i> Bin</a></li>
  ...
  <div class="row" style="padding-left:20%;padding-right:5px;margin-top:5%">
      ...
      <div class="card-header" style="width:90%;background:rgb(6, 24, 9)">
  <h5 class=" info-color white-text text-center py-4" style="color:white">
    <strong>NEW EMPLOYEE</strong>
      ...
      <form class="form-control" method="post" action="add_e.php" data-parsley-validate>
        ...
        <input class="form-control" type="text" placeholder="Last Name" name='lname' data-parsley-pattern="^[a-zA-Z'-]+$" data-parsley-trigger="keyup" data-parsley-error-message="Name contains Alphabets (A-Za-z) and symbols ('-)"><br>
...
<label for="">Address</label><br>
        <input class="form-control" type="text" placeholder="Address"  name='address' data-parsley-pattern="^[a-zA-Z0-9'-, ]+$" data-parsley-trigger="keyup" data-parsley-error-message="Name contains Alphanuemric characters (A-Za-z,0-9) and symbols ('-,)"><br>


        <label for="">Department</label><br>
        <input type="text" name="department" value="Maintenance" readonly>
...
<label for="">Telephone 1</label><br>
        <input class="form-control" type="text" placeholder="Telephone 1"  name='tel'  maxlength=10 data-parsley-pattern="^[0-9(10)]+$" data-parsley-trigger="keyup" data-parsley-error-message="Contains Numbers only and of length 10"><br>


        <label for="">Telephone 2</label><br>
        <input class="form-control" type="text" placeholder="Telephone 2"  name='tel1'  maxlength=10 data-parsley-pattern="^[0-9(10)]+$" data-parsley-trigger="keyup" data-parsley-error-message="Contains Numbers only and of length 10" ><br>
...
<label for="">Shift Time</label><br>
     ...
     <label for="">Cleaning Allocation</label><br>
        <select class="form-control" name="location" id="location">

<?php 
  $sql="SELECT COLUMN_TYPE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Maintenance' AND COLUMN_NAME = 'CleaningLocation' ";
  $result=mysqli_query($conn,$sql);
  while($row = mysqli_fetch_array($result)) {
     $type=$row['COLUMN_TYPE'];
...
// $output will now be: Equipment','Set','Show
  ...
  ?>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-success" style="margin-left:20%;width:35%" name='msubmit'>ADD </button>
      </div>
      </div>
      </form>
