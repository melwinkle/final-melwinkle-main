     ...
     <!-- This is the php file for adding a new employee in Security -->
<?php
  ...
  <h5 class=" info-color white-text text-center py-4" style="color:white">
    <strong>NEW SECURITY</strong>
      ...
      <form class="form-control" method="post" action="add_e.php" data-parsley-validate>
        ...
        <input class="form-control" type="text" placeholder="First Name" name='fname' data-parsley-pattern="^[a-zA-Z'-]+$"  maxlength=10 data-parsley-trigger="keyup" data-parsley-error-message="Name is Alphabets only (A-Za-z) and symbols('-)" ><br>




        <label for="">Last Name</label><br>
        <input class="form-control" type="text" placeholder="Last Name" name='lname' data-parsley-pattern="^[a-zA-z'-]+$"  maxlength=10  data-parsley-trigger="keyup" data-parsley-error-message="Name is Alphabets only (A-Za-z) and symbols('-)"><br>
...
<label for="">Address</label><br>
       ...
       <input type="text" name="department" id="department" value="Security" readonly>
...
<label for="">Telephone 1</label><br>
        <input class="form-control" type="text" placeholder="Telephone 1"  name='tel' data-parsley-pattern="^[0-9(10)]+$" data-parsley-trigger="keyup" data-parsley-error-message="Contains Numbers only and of length 10"><br>


        <label for="">Telephone 2</label><br>
        <input class="form-control" type="text" placeholder="Telephone 2"  name='tel1' data-parsley-pattern="^[0-9(10)]+$" data-parsley-trigger="keyup" data-parsley-error-message="Contains Numbers only and of length 10"><br>
...
<label for="">Shift Time</label><br>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-success" style="margin-left:20%;width:35%" name='submits'>ADD </button>
      </div>
      </div>
      </form>
